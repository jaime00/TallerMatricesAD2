...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Taller Matrices AD (No. 2)"));
        ...
        jPanel2.add(txtNumeroColumnas, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 110, 80, -1));
        ...
        jPanel2.add(txtNumeroFilas, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 50, 80, -1));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 50, 330, 170));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 50, 320, 150));
        ...
        cmbOperaciones.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Figura 1", "Figura 2", "Figura 3", "Figura 4", "Figura 5", "Figura 6", "Figura 7", "Figura 8", "Figura 9", "Figura 10", "Figura 11", "Figura 12" }));
        cmbOperaciones.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbOperacionesActionPerformed(evt);
            }
        });
        jPanel1.add(cmbOperaciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 230, 140, -1));
        ...
        jPanel1.add(txtMensaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 510, -1, 20));
    ...
    private void cmdOperacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOperacionActionPerformed
        ...
        switch (op) {
            case 0:
                Helper.Figura1(tblTablaInicial, tblTablaFinal);
                break;
            case 1:
                Helper.figura2(tblTablaInicial, tblTablaFinal);
                break;
            case 2:
                Helper.figura3(tblTablaInicial, tblTablaFinal);
                break;
            case 3:
                Helper.figura4(tblTablaInicial, tblTablaFinal);
                break;
            case 4:
                Helper.figura5(tblTablaInicial, tblTablaFinal);
                break;
            case 5:
                Helper.figura6(tblTablaInicial, tblTablaFinal);
                break;
            case 6:
                Helper.figura7(tblTablaInicial, tblTablaFinal);
                break;
            case 7:
                Helper.figura8(tblTablaInicial, tblTablaFinal);
                break;
            case 8:
                Helper.figura9(tblTablaInicial, tblTablaFinal);
                break;
            case 9:
                Helper.figura10(tblTablaInicial, tblTablaFinal);
                break;
            case 10:
                Helper.figura11(tblTablaInicial, tblTablaFinal);
                break;
            case 11:
                Helper.figura12(tblTablaInicial, tblTablaFinal);
                break;
        }
